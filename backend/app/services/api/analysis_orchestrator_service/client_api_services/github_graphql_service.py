...
from app.analyzers.code_and_repository_quality.estimated_commit_naming_quality_analyzer.estimated_commit_naming_quality_metric import get_estimated_commit_naming_quality_metric
...
async def analyze_repositories_github_graphql(
    ...
    return await run_repository_analysis(
        ...
        metric_executors=[
            ...
            get_estimated_commit_naming_quality_metric,
        ],
        subsequent_phases=[
