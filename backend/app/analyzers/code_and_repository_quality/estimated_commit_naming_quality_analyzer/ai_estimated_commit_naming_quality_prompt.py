...
(you may also use partial points, e.g. 15.5 / 20.0):

1. Consistency of naming convention (0.0–20.0)
...
2. Commit message length quality (0.0–20.0)
...
3. Use of meaningful technical / conventional terms (0.0–20.0)
...
4. Avoidance of vague / bad-practice wording (0.0–20.0)
- Penalize vague words like "stuff", "thing", "misc", "tmp", "wip", "random", etc.
- Penalize low-information commit naming habits.

5. Readability and clarity / does the message make logical sense (0.0–20.0)
...
Rules:
- Total score MUST be the sum of all 5 categories (0.0–100.0).
...
{{
  "rating": number (0.0-100.0, for example, 78.5),
